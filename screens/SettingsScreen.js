    ...
    return (
      <View style={styles.container}>
        <View style={[styles.headerContainer, styles.shadow]}>
          <Image source={require('../assets/settings.png')} resizeMode='contain' style={{tintColor: '#fff', width: 36,
                                height: 36,}}/>
          <Text style={styles.defaultText}>Configurações</Text>
        </View>
        
        <View style={styles.imgContainer}>
          <Image source={require('../assets/SettingsPick.jpg')} resizeMode='contain' style={{width: '100%', height: '100%', 
    }}/>
        </View>
